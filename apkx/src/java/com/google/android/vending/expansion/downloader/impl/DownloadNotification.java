...
public class DownloadNotification implements IDownloaderClient {
        ...
        if (newState != mState) {
            ...
            switch (newState) {
                ...
                case IDownloaderClient.STATE_DOWNLOADING:
                    ...
                    stringDownloadID = Helpers.getDownloaderStringFromState(newState);
                    ongoingEvent = true;
                    break;
    ...
    public void onDownloadProgress(DownloadProgressInfo progress) {
        ...
        if (progress.mOverallTotal <= 0) {
            ...
            mActiveDownloadBuilder.setContentInfo(String.format(R.string.time_remaining_notification,
